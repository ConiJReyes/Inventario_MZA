...
urlpatterns = [
    ...
    path('kits/crear/', views.crear_kit, name='crear_kit'),
    path('kits/', views.listar_kits, name='listar_kits'),
    path('kits/desarmar/<int:kit_id>/', views.desarmar_kit, name='desarmar_kit'),
    path('lotes/', views.listar_lotes, name='listar_lotes'),
    path('lotes/desbloquear/<int:lote_id>/', views.desbloquear_lote, name='desbloquear_lote'),
